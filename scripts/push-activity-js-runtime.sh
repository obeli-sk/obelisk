...
if [ "$TAG" != "dry-run" ]; then
    ...
    STRIPPED="$CARGO_TARGET_ROOT/release_wasm_runtime/wasm32-wasip2/release_wasm_runtime/activity_js_runtime.stripped.wasm"
    wasm-tools strip --all "$CARGO_TARGET_ROOT/release_wasm_runtime/wasm32-wasip2/release_wasm_runtime/activity_js_runtime.wasm" -o "$STRIPPED"
