...
impl From<wasmtime::component::Val> for ValWrapper {
    fn from(value: wasmtime::component::Val) -> Self {
        match value {
            wasmtime::component::Val::Bool(v) => Self::Bool(v),
            wasmtime::component::Val::S8(v) => Self::S8(v),
            wasmtime::component::Val::U8(v) => Self::U8(v),
            wasmtime::component::Val::S16(v) => Self::S16(v),
            wasmtime::component::Val::U16(v) => Self::U16(v),
            wasmtime::component::Val::S32(v) => Self::S32(v),
            wasmtime::component::Val::U32(v) => Self::U32(v),
            wasmtime::component::Val::S64(v) => Self::S64(v),
            wasmtime::component::Val::U64(v) => Self::U64(v),
            wasmtime::component::Val::Float32(v) => Self::Float32(v),
            wasmtime::component::Val::Float64(v) => Self::Float64(v),
            wasmtime::component::Val::Char(v) => Self::Char(v),
            wasmtime::component::Val::String(v) => Self::String(v),
            wasmtime::component::Val::List(_) => todo!(),
            wasmtime::component::Val::Record(_) => todo!(),
            wasmtime::component::Val::Tuple(_) => todo!(),
            wasmtime::component::Val::Variant(_) => todo!(),
            wasmtime::component::Val::Enum(_) => todo!(),
            wasmtime::component::Val::Option(_) => todo!(),
            wasmtime::component::Val::Result(_) => todo!(),
            wasmtime::component::Val::Flags(_) => todo!(),
            wasmtime::component::Val::Resource(_) => todo!(),
        }
    }
}
...
impl From<wasmtime::component::Type> for TypeWrapper {
    fn from(value: wasmtime::component::Type) -> Self {
        match value {
            wasmtime::component::Type::Bool => Self::Bool,
            wasmtime::component::Type::S8 => Self::S8,
            wasmtime::component::Type::U8 => Self::U8,
            wasmtime::component::Type::S16 => Self::S16,
            wasmtime::component::Type::U16 => Self::U16,
            wasmtime::component::Type::S32 => Self::S32,
            wasmtime::component::Type::U32 => Self::U32,
            wasmtime::component::Type::S64 => Self::S64,
            wasmtime::component::Type::U64 => Self::U64,
            wasmtime::component::Type::Float32 => Self::Float32,
...
mod tests {
    ...
    fn serialize_bool_to_json() {
        ...
        let wrapper = ValWrapper::from(val);
