...
pub(crate) mod v4_1_0 {
    ...
    pub(crate) use obelisk::types::execution::DelayId as DelayId_4_1_0;
    pub(crate) use obelisk::types::execution::ExecutionId as ExecutionId_4_1_0;
    pub(crate) use obelisk::types::execution::ResponseId as ResponseId_4_1_0;
    use obelisk::types::time::Datetime;
    pub(crate) use obelisk::types::time::Duration as DurationEnum_4_1_0;
    pub(crate) use obelisk::types::time::ScheduleAt as ScheduleAt_4_1_0;
    use std::str::FromStr;
    use std::time::Duration;
    ...
    wasmtime::component::bindgen!({
        ...
        world bindings {
            import obelisk:workflow/workflow-support@4.2.0;
            }",
    ...
    impl From<DurationEnum_4_1_0> for Duration {
        fn from(value: DurationEnum_4_1_0) -> Self {
            match value {
                DurationEnum_4_1_0::Milliseconds(millis) => Duration::from_millis(millis),
                DurationEnum_4_1_0::Seconds(secs) => Duration::from_secs(secs),
                DurationEnum_4_1_0::Minutes(mins) => Duration::from_secs(u64::from(mins * 60)),
                DurationEnum_4_1_0::Hours(hours) => Duration::from_secs(u64::from(hours * 60 * 60)),
                DurationEnum_4_1_0::Days(days) => {
    ...
    impl From<ScheduleAt_4_1_0> for HistoryEventScheduleAt {
        fn from(value: ScheduleAt_4_1_0) -> Self {
            match value {
                ScheduleAt_4_1_0::Now => Self::Now,
                ScheduleAt_4_1_0::At(datetime) => Self::At(DateTime::from(datetime)),
                ScheduleAt_4_1_0::In(duration) => Self::In(Duration::from(duration)),
            }
        }
    }
    ...
    mod into_val {
        use crate::workflow::host_exports::v4_1_0::ResponseId_4_1_0;
        ...
        impl From<ResponseId_4_1_0> for Val {
            fn from(value: ResponseId_4_1_0) -> Self {
                match value {
                    ResponseId_4_1_0::ExecutionId(execution_id) => Self::Variant(
                        "execution-id".to_string(),
                        Some(Box::new(Self::from(execution_id))),
                    ),
                    ResponseId_4_1_0::DelayId(delay_id) => {
        ...
        ("at", Some(date_time)) if matches!(date_time.deref(), WastVal::Record(_)) => {
            ...
            match (date_time.len(), seconds, nanoseconds) {
                (2, Some(WastVal::U64(seconds)), Some(WastVal::U32(nanoseconds))) => {
                    let date_time = v4_1_0::obelisk::types::time::Datetime {
                        seconds: *seconds,
