...
pub(crate) mod latest {
    ...
    use obelisk::types::function as types_function;
    ...
    impl From<&FunctionFqn> for types_function::Function {
    ...
    mod into_val {
        ...
        use super::obelisk::types::function as types_function;
        use wasmtime::component::Val;

        impl From<types_function::Function> for Val {
            fn from(value: types_function::Function) -> Self {
                Self::Record(vec![
                    (
