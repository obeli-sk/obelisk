      ...
      pub mod testing {
        pub mod http {
          ...
          pub mod http_get {
            ...
            pub trait Guest {
              fn get(authority: wit_bindgen::rt::string::String,path: wit_bindgen::rt::string::String,) -> Result<wit_bindgen::rt::string::String,wit_bindgen::rt::string::String>;
            }
