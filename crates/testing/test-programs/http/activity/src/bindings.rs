...
macro_rules! __export_any_impl {
  ...
  $($path_to_types_root)*::exports::testing::http::http_get::__export_testing_http_http_get_cabi!($ty with_types_in $($path_to_types_root)*::exports::testing::http::http_get);
  )
}
#[doc(inline)]
